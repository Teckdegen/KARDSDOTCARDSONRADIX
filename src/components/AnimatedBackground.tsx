...
export default function AnimatedBackground() {
  useEffect(() => {
    ...
    class CardStreamController {
      ...
      onDrag(e) {
        if (!this.isDragging || !this.cardLine) return;
        e.preventDefault();
  ...
  return (
    <div className="fixed inset-0 -z-10 pointer-events-none">
      <div className="relative w-screen h-screen flex items-center justify-center">
        <canvas id="particleCanvas" className="absolute top-1/2 left-0 -translate-y-1/2 w-screen h-[250px] pointer-events-none" />
        <canvas id="scannerCanvas" className="absolute top-1/2 left-0 -translate-y-1/2 w-screen h-[300px] pointer-events-none" />
