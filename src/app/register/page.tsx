      ...
      <div className="w-full max-w-md">
        <GlassCard className="fade-in">
          ...
          <div className="mt-8 text-center">
            <Link href="/login" className="text-white/60 text-sm hover:text-white/80 transition-all duration-300 inline-flex items-center gap-2 group">
              Already have an account? <span className="text-[#F5F5DC] group-hover:underline">Login</span>
            </Link>
          </div>
        </GlassCard>
      </div>
