      ...
      <div className="w-full max-w-md">
        <GlassCard className="fade-in">
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-3" style={{ color: 'rgba(245, 245, 220, 0.6)' }}>Welcome back</h1>
            <p className="text-white/40 text-base md:text-lg">Sign in to continue</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <Link href="/register" className="text-white/40 text-sm hover:text-white/60 transition-all duration-300 inline-flex items-center gap-2 group">
